    ...
    <div class="light-container" @mousemove="isActive = true" @mouseleave="isActive = false">
      ...
      <div class="content">
        ...
        <div class="min-h-[100dvh] flex flex-col items-center justify-center p-4 text-center z-50 relative">
          <div class="max-w-md w-full bg-red-50 dark:bg-red-950/40 p-8 rounded-3xl shadow-2xl border border-red-200 dark:border-red-900/50 backdrop-blur-xl">
            <div class="w-20 h-20 mx-auto bg-red-100 dark:bg-red-900/50 text-red-600 dark:text-red-400 rounded-full flex items-center justify-center mb-6 shadow-inner">
            ...
            <p class="text-gray-600 dark:text-gray-300 mb-8 leading-relaxed text-sm">
              Saat ini kami sedang mengalami gangguan akses pada sistem. Tim teknis kami sedang berupaya penuh untuk memulihkannya secepat mungkin. <br><br>Mohon maaf atas ketidaknyamanan ini.
            </p>
            <div class="inline-flex items-center justify-center space-x-2 text-sm text-red-700 dark:text-red-400 font-semibold bg-red-100 dark:bg-red-900/50 px-5 py-2.5 rounded-full border border-red-200 dark:border-red-800/50">
