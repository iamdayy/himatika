    ...
    <UCard>
        ...
        <div v-else>
            ...
            <div v-if="viewMode === 'grid'" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <UCard class="hover:shadow-lg transition-shadow" v-for="agenda, i in agendas.data" :key="i">
                    <template #header>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative h-48 rounded-lg overflow-hidden">
                            ...
                            <div v-else
                                ...
                                <UIcon name="i-heroicons-photo" class="w-12 h-12 text-gray-400 dark:text-gray-500" />
                            </div>
                        </div>
                        <!-- Date and Location -->
                        <div class="space-y-2">
            ...
            <div v-else class="space-y-4">
                <UCard class="hover:shadow-md transition-shadow" v-for="agenda, i in agendas.data" :key="i">
                            ...
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex-1">
                                    ...
                                    <div v-if="agenda.tags && agenda.tags.length" class="flex flex-wrap gap-1 mb-3">
                                        ...
                                        <UBadge v-if="agenda.tags.length > 5" color="neutral" variant="soft" size="xs">
