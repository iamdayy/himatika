...
export const seedEvent = async () => {
    ...
    canSee: idFaker.helpers.arrayElement(["Admin", "Departement", "Internal", "All", "External", "No"]),
    ...
    canRegister: idFaker.helpers.arrayElement(["Admin", "Departement", "Internal", "All", "External", "No"]),
      };
