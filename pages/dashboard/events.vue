                    ...
                    <div class="px-2 py-4 text-start">
                        <div class="space-y-4">
                            <div class="grid grid-cols-6 gap-6 px-4">
                                ...
                                <div class="col-span-3">
                                    <FormSelect title="Can See"
                                        :options="['Admin', 'Departement', 'Internal', 'All', 'External']"
                                            ...
                                            <div class="flex">
                                                <div class="flex items-center w-full gap-2">
                                                    <div class="w-3/4">
                                                        ...
                                                        <input :type="`${committee.job}-job`"
                                                            :name="`${committee.job}-job`" :id="`${committee.job}-job`"
                                                            v-model="newEvent.committee![i].job"
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                                            required>
                                                    </div>
                                                    <div class="w-1/4">
                                                        ...
                                                        <input :type="`${committee.job}-profile`"
                                                            :name="`${committee.job}-profile`"
        ...
        <div class="flex flex-col w-full gap-3 px-8 py-12 md:flex-row">
            ...
            <div class="w-full px-8 py-4 bg-gray-100 border border-gray-400 rounded-lg shadow-lg">
                ...
                <div v-else>
                    ...
                    <button type="submit" v-if="canMeRegister(Event.canRegister, Event.date) && !isMeRegistered(Event)"
